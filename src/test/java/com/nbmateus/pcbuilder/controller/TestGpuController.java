...
public class TestGpuController {
    ...
    public void testGetAll() throws Exception {
        MvcResult mvcResult = mockMvc
                .perform(MockMvcRequestBuilders.get("/gpu/all").accept(MediaType.APPLICATION_JSON_VALUE)).andReturn();
    ...
    public void testGetGpuByIdSuccessfully() throws Exception {
        MvcResult mvcResult = mockMvc
                .perform(MockMvcRequestBuilders.get("/gpu/3").accept(MediaType.APPLICATION_JSON_VALUE)).andReturn();
    ...
    public void testGetGpuByIdNotFound() throws Exception {
        MvcResult mvcResult = mockMvc
                .perform(MockMvcRequestBuilders.get("/gpu/9").accept(MediaType.APPLICATION_JSON_VALUE)).andReturn();

        System.out.println("\ntestGetGpuByIdNotFound: "+mvcResult.getResponse().getStatus()+"\n");
        System.out.println("\ntestGetGpuByIdNotFound: "+mvcResult.getResponse().getContentAsString()+"\n");
    ...
    public void testAddGpuSuccessfully() throws Exception {
        ...
        MvcResult mvcResult = mockMvc.perform(MockMvcRequestBuilders.post("/gpu/add")
                .contentType(MediaType.APPLICATION_JSON_VALUE).content(objectMapper.writeValueAsString(gpu)))
                .andReturn();
    ...
    public void testUpdateGpuSuccesfully() throws Exception {
        ...
        MvcResult mvcResult = mockMvc.perform(MockMvcRequestBuilders.put("/gpu/4").contentType(MediaType.APPLICATION_JSON)
    ...
    public void testUpdateGpuNotFound() throws Exception {
        MvcResult mvcResult = mockMvc
                .perform(MockMvcRequestBuilders.get("/gpu/8").accept(MediaType.APPLICATION_JSON_VALUE)).andReturn();
    ...
    public void testDeleteGpuSuccessfully() throws Exception {
            MvcResult mvcResult = mockMvc.perform(MockMvcRequestBuilders.delete("/gpu/1")).andReturn();
            assertTrue(mvcResult.getResponse().getStatus() == HttpStatus.NO_CONTENT.value());
    }

    @Test
    public void testDeleteGpuNotFound() throws Exception {
            MvcResult mvcResult = mockMvc.perform(MockMvcRequestBuilders.delete("/gpu/10")).andReturn();
            assertTrue(mvcResult.getResponse().getStatus() == HttpStatus.NOT_FOUND.value());
    }
}